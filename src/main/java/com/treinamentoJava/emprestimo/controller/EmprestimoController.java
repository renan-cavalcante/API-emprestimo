...
public class EmprestimoController {
	...
	public List<EmprestimoDTO> retornarTodosOsEmprestimos(@PathVariable Long cpf) throws  EmprestimoNaoEncontrado, ClienteNaoEncontrado{
	...
	public EmprestimoDTO retornarEmprestimo( @PathVariable Long id) throws  EmprestimoNaoEncontrado{
	...
	public MensagemDeSucesso cadastrarEmprestimo(@Valid @RequestBody EmprestimoDTO emprestimoDTO, @PathVariable Long cpf) throws EmprestimoNaoEncontrado, ClienteNaoEncontrado  {
	...
	public Emprestimo alterarEmprestimo(@PathVariable Long cpf, @Valid @RequestBody Emprestimo emprestimo)  throws  EmprestimoNaoEncontrado, ClienteNaoEncontrado {
		return this.emprestimoService.alterarEmprestimo(cpf, emprestimo);
	}
	
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@DeleteMapping("/emprestimos/{id}") 
	public MensagemDeSucesso deletarEmprestimo(@PathVariable Long cpf) throws EmprestimoNaoEncontrado{
